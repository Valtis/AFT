...
\note Running AFT once instead of booting the image is acceptable as well, as AFT will boot the support image. This is however slower as AFT will also perform flashing.
